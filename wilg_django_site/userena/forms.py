...
from accounts.models import Major, ExecRole, Location, Affiliation, MyProfile
...
class MajorForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kw):
        super(MajorForm, self).__init__(*args, **kw)
...
class ExecForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kw):
        super(ExecForm, self).__init__(*args, **kw)
...
class AffiliationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kw):
        super(AffiliationForm, self).__init__(*args, **kw)
        self.fields['start_date'].widget = SelectDateWidget(years=range(1960, datetime.today().year + 1))
        self.fields['end_date'].widget = SelectDateWidget(years=range(1960, datetime.today().year + 1))
...
class EditProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kw):
        ...
        new_order.insert(2, 'school')
        self.fields.keyOrder = new_order
        self.fields["blurb"].widget = forms.widgets.Textarea()
        self.fields["oww"] = forms.ModelChoiceField(queryset=MyProfile.objects.order_by("user__first_name"), required=False)
        self.fields["oww"].label = "Old wise one"
