...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MinorConc'
        db.create_table('accounts_minorconc', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.MyProfile'])),
        ))
        db.send_create_signal('accounts', ['MinorConc'])


    def backwards(self, orm):
        # Deleting model 'MinorConc'
        db.delete_table('accounts_minorconc')
