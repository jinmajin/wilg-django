...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyProfile.school'
        db.add_column('accounts_myprofile', 'school',
                      self.gf('django.db.models.fields.CharField')(default='MIT', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyProfile.school'
        db.delete_column('accounts_myprofile', 'school')
